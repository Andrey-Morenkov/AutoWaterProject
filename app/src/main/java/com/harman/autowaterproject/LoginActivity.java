 ...
 */
public class LoginActivity extends AppCompatActivity implements Handler.Callback, LoaderCallbacks<Cursor>
{
    private final int SERVER_REQUEST = 121212;
    ...
    {
        Log.d(LogPrefix,"Incoming handle message" + msg.obj.toString());
        ...
        {
            Snackbar snackbar = make(linearLayout, "Неизвестный ответ сервера", Snackbar.LENGTH_SHORT);
            snackbar.show();
        }
        return true;
    }
